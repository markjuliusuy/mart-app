                    ...
                    >
                        <template v-slot:table-row="props">
                            <span v-if="props.column.field == 'actions'">
                                <inertia-link :href="route(route_edit, props.row.id)" class="text-sm text-gray-700 underline">Edit</inertia-link><button  @click="destroy(props.row.id)" class="text-sm underline ml-1" v-if="props.row.user_permissions.delete" >Delete</button>
                            </span>
                            <span v-else>
